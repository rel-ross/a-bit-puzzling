...
london = Puzzle.create(title: "London", design: "photo of London", number_of_pieces: 500, in_progress: false)
colorado = Puzzle.create(title: "Colorado", design: "CO graphic illustration", number_of_pieces: 500, in_progress: false)
